...
class TrainingHparams(object):
    ...
    Members:
        ...
        max_conversations: number of conversations to use from the cornell dataset_old. Specify -1 for no limit.
            pick a lower limit if training on the whole dataset_old is too slow (for lower-end GPUs)
        ...
        validation_set_percent: the percentage of the training dataset_old to use as the validation set.
        
        random_train_val_split: 
            True to split the dataset_old randomly. 
            False to split the dataset_old sequentially 
        ...
        epochs: Number of epochs to train (1 epoch = all samples in dataset_old)
        ...
        log_summary: True to log training stats
    ...
    def __init__(self):
        ...
        self.validation_set_percent = 20
...
class InferenceHparams(object):
    """Hyperparameters used when chatting with the chatbot model (prediction or inference).
